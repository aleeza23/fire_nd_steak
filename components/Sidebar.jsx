...
const Sidebar = ({ isOpen }) => {
    return (
        <div className={`fixed top-0 left-0 h-full z-50 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} xl:translate-x-0 transition-transform w-[55vw]  xl:w-[17vw] bg-[#000]`}>
