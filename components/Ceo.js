            ...
            <div className="container mx-auto px-4 flex flex-col lg:flex-row ">
                <div className="lg:w-1/2 relative h-72 px-12 ">
                    <Image
                        src={newSectionImage}
                        fill
                        sizes="(min-width: 1980px) 752px, (min-width: 1320px) calc(34.38vw + 78px), (min-width: 1040px) calc(10.77vw + 384px), (min-width: 780px) 736px, (min-width: 680px) 608px, calc(94.44vw - 15px)"
