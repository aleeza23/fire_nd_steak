...
const MenuData = [
    {
        ...
        description: 'Succulent steak, grilled to perfection with a rich sauce and seasoned to satisfy.',
        subMenuItems: [
            {
    ...
    },
    {
        ...
        link: '/menu/grilled-chicken',
        description: 'Tender grilled chicken seasoned with spices and served with a choice of side.',
        subMenuItems: [
            {
...

    {
        ...
        description: 'Start your meal with a range of tasty appetizers, perfect for any occasion.',
        subMenuItems: [
